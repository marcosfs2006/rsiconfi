...
#' @param year a numeric vector representing the year, with four digits
#' @param annex character vector of lenght one indicating the annex to be consulted
...
#' @param In_QDCC boolean indicating if XXX. Default = FALSE
#'
#' @return dataframe
#' @export
#'
